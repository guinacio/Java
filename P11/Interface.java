...
public class Interface {
	...
	public void showSalMedioC(double soma, int cont)
	{
		if(cont == 0)
			JOptionPane.showMessageDialog(null,"Não há chefes");
		else
		    JOptionPane.showMessageDialog(null,"O salario medio dos chefes é: " + (soma/cont));
	}
